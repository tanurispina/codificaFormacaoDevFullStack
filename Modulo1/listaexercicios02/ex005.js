...
switch (opcaoEscolhida) {
  case 1:
    let primeiroJogador = Number(
      prompt("Jogador 1: Escolha a opcao: 1- Pedra; 2 - Papel 3 - Tesoura: ")
    );
    let segundoJogador = Number(
      prompt("Jogador 2: Escolha a opcao: 1- Pedra; 2 - Papel 3 - Tesoura: ")
    );
